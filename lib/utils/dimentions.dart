...
class Dimentions {
  //current screen height: 844
  //current screen width: 390
  ...
  static double height250 = screenHeight / 3.376;
  ...
  static double height390 = screenHeight / 2.16;
  ...
  static double width16 = screenWidth / 24.375;
  ...
  static double icon18 = screenHeight / 46.89;
  static double icon24 = screenHeight / 35.17;
  static double icon35 = screenHeight / 24.11;
  ...
  static double font70 = screenHeight / 12.06;
}
